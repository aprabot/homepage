  ...
  const LYRA_AVATAR_SVG = '<svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">'
    + '<ellipse cx="16" cy="15" rx="9.3" ry="7.8" fill="#2B2118"/>'
    + '<circle cx="16" cy="6.2" r="3.7" fill="#2B2118"/>'
    + '<ellipse cx="16" cy="8.4" rx="3.7" ry="1" fill="#C8F24E"/>'
    + '<ellipse cx="16" cy="19" rx="7.9" ry="8.8" fill="#E8B685"/>'
    + '<path d="M6.4 16.4 Q16 2.4 25.6 16.4" stroke="#54E6C4" stroke-width="1.7" stroke-linecap="round" fill="none"/>'
    + '<ellipse cx="6.4" cy="17.6" rx="2.5" ry="3.3" fill="#1C2233" stroke="#54E6C4" stroke-width="1.1"/>'
    + '<ellipse cx="25.6" cy="17.6" rx="2.5" ry="3.3" fill="#1C2233" stroke="#54E6C4" stroke-width="1.1"/>'
    + '<ellipse cx="12.3" cy="18.5" rx="1.5" ry="1.7" fill="#1a1a2e"/>'
    + '<ellipse cx="19.7" cy="18.5" rx="1.5" ry="1.7" fill="#1a1a2e"/>'
    + '<circle cx="11.7" cy="17.8" r="0.55" fill="white"/>'
    + '<circle cx="20.3" cy="17.8" r="0.55" fill="white"/>'
    + '<ellipse cx="11.2" cy="21.4" rx="1.5" ry="0.9" fill="#E8896B" opacity=".4"/>'
    + '<ellipse cx="20.8" cy="21.4" rx="1.5" ry="0.9" fill="#E8896B" opacity=".4"/>'
    + '<path d="M12.3 24 Q16 26.7 19.7 24" stroke="#a5623f" stroke-width="1.3" stroke-linecap="round" fill="none"/>'
    + '<rect x="24" y="8.3" width="1.6" height="7.6" rx="0.7" fill="#C8F24E" transform="rotate(18 24 8.3)"/>'
    + '<path d="M7 31.6 Q11.3 27.2 16 26.6 Q20.7 27.2 25 31.6 L25 32 L7 32 Z" fill="#232A3D"/>'
    + '<path d="M12.6 27.4 L16 30.3 L19.4 27.4 L16 26.5 Z" fill="#7AA2FF"/>'
    + '</svg>';
